...
"""
"""
Note: the values are hard coded. Change them everytime running a new instance.
...
def locsEstimatePerStormImage(stormtiff_directory, tile_size, storm_image_scale, img_df, locs_est_dict_file_name, channel, uint8, sema):
    ...
    if (channel == "561storm"):
        ...
        if uint8:
            ...
            coef1 = [0.02000600774034275, 0.12777890664004474]
            coef2 = [0.00019541994540224367, -0.02794677005976942, 1.7523987972765172]             
