...
def makeTiles(expfolder, storm_exp_name, tile_size, tiles_df, tile_input, uint8, roi):
    ...
    if not os.path.exists(expfolder + "make_data\\" + data_directory_str + "tiles\\"):
        os.mkdir(expfolder + "make_data\\" + data_directory_str + "tiles\\")
        # os.mkdir(storm_exp_directory + data_directory_str + "locs\\")        

    tiles_directory = expfolder + "make_data\\" + data_directory_str + "tiles\\"
