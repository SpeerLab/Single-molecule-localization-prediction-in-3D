...
Here, when mol_list = True will plot the initial estimation plot. 
"""
...
experiment_directory = expfolder + "experiments\\" + "model_predictions\\" +  "experiment_1\\"
...
if mol_list:
    num_locs_directory = data_directory + data_directory_str + "num_locs_estimate\\"
...
if mol_list:    
    num_locs_tile_file_name = num_locs_directory + "storm_num_locs_est_lin_fit_tile_" + str(tile_id) + ".data" 
