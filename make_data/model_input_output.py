...
def modelInputOutput(expfolder, storm_exp_name, channel, tile_size, max_processes, storm_image_scale, tiles_df, locsPerTile2, locsPerTile2Tmp, uint8, roi, clust_pix_list_full_file):
    ...
    total_tiles = makeTiles(expfolder, storm_exp_name, tile_size, tiles_df, tile_input, uint8, roi)
    
    # Make localization files for individual tiles.             
    total_loc_files = locsFromTiles(expfolder, storm_exp_name, tile_size, num_locs_output, num_locs_est_lin_fit_output, num_locs_est_quad_fit_output, max_processes, storm_image_scale, tiles_df, locsPerTile2, uint8, roi, clust_pix_list_full_file)            
