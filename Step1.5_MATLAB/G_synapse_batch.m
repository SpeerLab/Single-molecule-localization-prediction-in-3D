...
parfor file_id = 1:18
    ...
    outpath = [base_path 'analysis\Result\ML_data_batch_750pos\'];
    ...
    statsGwater_sssss = load([inpath 'G_paired_VC.mat'],'statsGwater_sssss');
    statsGwater_sssss = statsGwater_sssss.statsGwater_sssss;
...
parfor file_id = 1:18
    ...
    Result_folder = [base_path 'analysis\Result\'];
    inpath = [Result_folder '4_CTB\'];
    outpath = [base_path 'analysis\Result\ML_data_batch_750neg\'];
    if exist(outpath,'dir')~=7
        mkdir(outpath);
    end
    storm_folder = [base_path 'analysis\elastic_align\storm_merged\'];
    ...
    num_images = numel(files);
    info = imfinfo([storm_folder files(1).name]);
    statsGwater_ssssn = load([inpath 'G_paired_VC.mat'],'statsGwater_ssssn');
    statsGwater_sssss = statsGwater_ssssn.statsGwater_ssssn;
