...
if mol_list:
    if randm:
        ...
        if not os.path.exists(storm_exp_directory + "gt_dbscan_output_sequences_mol_list_eps_" + str(eps) + "_min_smpl_" + str(min_samples) + "\\"):
            os.mkdir(storm_exp_directory + "gt_dbscan_output_sequences_mol_list_eps_" + str(eps) + "_min_smpl_" + str(min_samples) + "\\")
    
        dbscan_seq_directory = storm_exp_directory + "gt_dbscan_output_sequences_mol_list_eps_" + str(eps) + "_min_smpl_" + str(min_samples) + "\\" 

else:
    if randm: 
        if not os.path.exists(expfolder + "dbscan_output_random_sequences_eps_" + str(eps) + "_min_smpl_" + str(min_samples) + "\\"):
            os.mkdir(expfolder + "dbscan_output_random_sequences_eps_" + str(eps) + "_min_smpl_" + str(min_samples) + "\\")
        
        dbscan_seq_directory = expfolder + "dbscan_output_random_sequences_eps_" + str(eps) + "_min_smpl_" + str(min_samples) + "\\" 

    else: 
        if not os.path.exists(expfolder + "gt_dbscan_output_sequences_eps_" + str(eps) + "_min_smpl_" + str(min_samples) + "\\"):
            os.mkdir(expfolder + "gt_dbscan_output_sequences_eps_" + str(eps) + "_min_smpl_" + str(min_samples) + "\\")
        
        dbscan_seq_directory = expfolder + "gt_dbscan_output_sequences_eps_" + str(eps) + "_min_smpl_" + str(min_samples) + "\\"         
...
if cluster_3d:
    ...
    if mol_list:
        ...
        if randm:
            locs_sequences_directory = expfolder + "random_cluster_sequences\\"        
            
        else:    
            locs_sequences_directory = expfolder + "locs3d_gt_sequences\\"
    ...
    for file in files:
        ...
        try:
            ...
            print("skip blank tiles")
            locs3d_seq_arr = np.array([[1,1,1],[2,2,2]])
