...
if mol_list:
    ...
    if randm: 
        ...
        if not os.path.exists(expfolder + "dbscan_output_sequences_eps_" + str(eps) + "_min_smpl_" + str(min_samples) + "\\"):
            os.mkdir(expfolder + "dbscan_output_sequences_eps_" + str(eps) + "_min_smpl_" + str(min_samples) + "\\")
