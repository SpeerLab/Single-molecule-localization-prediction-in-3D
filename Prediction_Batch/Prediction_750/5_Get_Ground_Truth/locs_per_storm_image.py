...
"""
"""
Switch from localizationsIterator to TracksIterator.

Chenghang 5/19/22
"""
import numpy as np
import sys
sys.path.append("C:\\Users\\Chenghang\\AppData\\Local\\Programs\\Python\\Python310\\pyenv\\sa_python3\\Lib\\site-packages\\")
import storm_analysis.sa_library.sa_h5py as saH5Py
import pickle
import math
import multiprocessing 

def locsPerStormImage(h5_file, tile_size, img_df, locs_dict_file_name, sema):
