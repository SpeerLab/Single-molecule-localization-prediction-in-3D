...
experiment_directory = "X:\\Chenghang\\4_Color\\Raw\\12.21.2020_P8EA_B_V2\\"
...
if mol_list: 
    ...
    if randm:
        ...
        dbscan_seq_directory = experiment_directory + "gt_dbscan_output_sequences_eps_" + str(eps) + "_min_smpl_" + str(min_samples) + "\\"     
...
if mol_list: 
    ...
    if randm:
        ...
        locs_sequences_directory = experiment_directory + "locs3d_gt_sequences\\"    
