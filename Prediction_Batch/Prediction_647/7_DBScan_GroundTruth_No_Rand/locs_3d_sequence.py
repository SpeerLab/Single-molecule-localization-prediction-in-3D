...
locs_3d_directory = storm_exp_directory + "chenghang_list_tilesize_72\\num_locs_gtgt\\"
...
if not os.path.exists(expfolder + "locs3d_gtgt_sequences\\"):
    os.mkdir(expfolder + "locs3d_gtgt_sequences\\")
