...
if __name__ == "__main__": 
    ...
    storm_exp_name = "ML_result_647_neg"    
    ...
    for idx in df.index:
        ...
        numLocsPerTile(tile_size, tile_id, coef1, coef2, stormtiff_file, locs_est_storm_lin_fit, locs_est_storm_quad_fit, num_locs_est_tile_lin_fit_file_name, num_locs_est_tile_quad_fit_file_name, sema)      
